...
class GameScene(Scene):
    def __init__(self):
        ...
        PLAYER_IMGS = {
            ...
            "N": load_img("player_n.png", IMG_DIR, SCALE).convert_alpha(),
            "R": load_img("player_r.png", IMG_DIR, SCALE).convert_alpha()
        }
    ...
    def update(self, dt):
        ...
        hits = pygame.sprite.groupcollide(friendlies_g, hostiles_g, True, True)
        #print(hits)
